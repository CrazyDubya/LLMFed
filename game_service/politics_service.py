...
from game_service.lifecycle_constants import (
    MAX_STAT_CAP,
    TENURE_MULTIPLIER, TENURE_CAP, POPULARITY_DIVISOR,
    LEADER_POLITICS, LEADER_POP,
    RESPECTED_POLITICS, RESPECTED_WORK_ETHIC,
    DISLIKED_POLITICS, DISLIKED_WORK_ETHIC,
    TOXIC_POLITICS, TOXIC_WORK_ETHIC,
    LEADER_MORALE_BASELINE, LEADER_MORALE_DIVISOR,
    CREATIVE_CONTROL_THRESHOLD, CREATIVE_CONTROL_FINISHES,
    CREATIVE_CONTROL_ALTERNATIVES, CREATIVE_CONTROL_DIVISOR,
)
...
def apply_politics_to_booking(db: Session, wrestler: GameWrestlerDB,
    ...
    if influence > CREATIVE_CONTROL_THRESHOLD and planned_finish in CREATIVE_CONTROL_FINISHES:
