...
RIVALRY_HEAT_RATING_DIVISOR = 200.0  # Divisor for converting rivalry heat to rating bonus
...
MAIN_EVENT_TOP_BONUS = 0.0           # (main events get longer matches, which gives indirect bonus)
